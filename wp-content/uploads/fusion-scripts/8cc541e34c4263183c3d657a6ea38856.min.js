...
var fusionAnimationsVars={"disable_mobile_animate_css":"0"};jQuery(window).load(function(){"function"==typeof jQuery.fn.equalHeights&&(jQuery(".fusion-events-shortcode").each(function(){jQuery(this).find(".fusion-events-meta").equalHeights()}),jQuery(window).on("resize",function(){jQuery(".fusion-events-shortcode").each(function(){jQuery(this).find(".fusion-events-meta").equalHeights()})}))});
